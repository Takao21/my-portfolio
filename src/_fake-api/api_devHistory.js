export const devHistory = [
  {
    ...
    date: "Childhood",
    story:
      "He was one of the top students throughout his Primary to High School life, with some experience competing in local top-student competitions. Ranked in Class A or B for most years among 10 classes.",
  },
  {
    entry: 1,
    date: "May, 2017",
    story:
      'His hobby of watching animes (Japanese animations) and keen interest in softwares led him to work part-time as "Wordpress Web Editor & Content Creator" on AniDL.org, a video downloading website for animes, with some senior developers from India.',
  },
  {
    entry: 2,
    date: "December, 2017",
    story:
      "Passed the Matriculation Exam with flying colors, achieving Distinctions in Applied Chemistry, Physics, Biology, Maths and English, and enrolled at Yangon Technological University, which is considered as one of the best in Myanmar. Major in Computer Engineering Information Technology.",
  },
  {
    entry: 3,
    date: "April, 2018",
    story:
      "Together with his classmates, he took a course on C++ with a private tutor for 10 weeks. That was the first encounter and step into learning programming languages.",
  },
  {
    entry: 4,
    date: "May, 2018",
  ...
  },
  {
    ...
    date: "February, 2021",
    story:
      "For about half a year, he was successfully running his start-up while honing his technical skills. But on Feb 2021, the infuriating Myanmar Coup d'etat happened. The growing start-up was forced to stop due to the crashing of digital industry.",
  },
];
